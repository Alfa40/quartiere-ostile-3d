...
const WEAPONS := {
	"pistola_aria_compressa": {
		...
		"price_money": 230, "price_material": "metallo", "price_amount": 8,
	...
	"revolver_arrugginito": {
		...
		"price_money": 425, "price_material": "metallo", "price_amount": 12,
	...
	"semiautomatica_9mm": {
		...
		"price_money": 785, "price_material": "metallo", "price_amount": 18,
	...
	"pistola_tattica": {
		...
		"price_money": 1455, "price_material": "metallo", "price_amount": 24,
	...
	"magnum_44": {
		...
		"price_money": 2695, "price_material": "metallo", "price_amount": 32,
	...
	"mitraglietta_aria_compressa": {
		...
		"price_money": 800, "price_material": "metallo", "price_amount": 30,
	...
	"mitraglietta_compatta": {
		...
		"price_money": 1480, "price_material": "metallo", "price_amount": 40,
	...
	"mitraglietta_tattica": {
		...
		"price_money": 2740, "price_material": "metallo", "price_amount": 55,
	...
	"mitraglietta_militare": {
		...
		"price_money": 5065, "price_material": "metallo", "price_amount": 70,
	...
	"mitraglietta_incursione": {
		...
		"price_money": 9370, "price_material": "metallo", "price_amount": 90,
	...
	"mitra_artigianale": {
		...
		"price_money": 1050, "price_material": "metallo", "price_amount": 35,
	...
	"mitra_pattuglia": {
		...
		"price_money": 1940, "price_material": "metallo", "price_amount": 45,
	...
	"mitra_pesante": {
		...
		"price_money": 3595, "price_material": "metallo", "price_amount": 60,
	...
	"fucile_tricolpo": {
		...
		"price_money": 3955, "price_material": "metallo", "price_amount": 68,
	...
	"mitra_assalto": {
		...
		"price_money": 6650, "price_material": "metallo", "price_amount": 78,
	...
	"mitra_guerra": {
		...
		"price_money": 12300, "price_material": "metallo", "price_amount": 100,
	...
	"pompa_arrugginito": {
		...
		"price_money": 1350, "price_material": "metallo", "price_amount": 38,
	...
	"pompa_corto": {
		...
		"price_money": 2500, "price_material": "metallo", "price_amount": 50,
	...
	"pompa_tattico": {
		...
		"price_money": 4620, "price_material": "metallo", "price_amount": 65,
	...
	"pompa_militare": {
		...
		"price_money": 8550, "price_material": "metallo", "price_amount": 85,
	...
	"pompa_demolizione": {
		...
		"price_money": 15815, "price_material": "metallo", "price_amount": 110,
	...
	"fucile_caccia": {
		...
		"price_money": 1900, "price_material": "metallo", "price_amount": 50,
	...
	"carabina_precisione": {
		...
		"price_money": 3515, "price_material": "metallo", "price_amount": 65,
	...
	"tiratore_scelto": {
		...
		"price_money": 6505, "price_material": "metallo", "price_amount": 85,
	...
	"anti_materiale": {
		...
		"price_money": 12030, "price_material": "metallo", "price_amount": 110,
	...
	"cecchino_leggendario": {
		...
		"price_money": 22255, "price_material": "metallo", "price_amount": 150,
	...
	"lanciagranate_improvvisato": {
		...
		"price_money": 5500, "price_material": "metallo", "price_amount": 70,
	...
	"lanciagranate_a_pompa": {
		...
		"price_money": 8800, "price_material": "metallo", "price_amount": 90,
	...
	"lanciagranate_semiautomatico": {
		...
		"price_money": 14080, "price_material": "metallo", "price_amount": 115,
	...
	"lanciagranate_militare": {
		...
		"price_money": 22530, "price_material": "metallo", "price_amount": 145,
	...
	"lanciagranate_pesante": {
		...
		"price_money": 36045, "price_material": "metallo", "price_amount": 180,
	...
	"lanciarazzi_tubo": {
		...
		"price_money": 7500, "price_material": "metallo", "price_amount": 85,
	...
	"lanciarazzi_improvvisato": {
		...
		"price_money": 12000, "price_material": "metallo", "price_amount": 105,
	...
	"lanciarazzi_militare": {
		...
		"price_money": 19200, "price_material": "metallo", "price_amount": 130,
	...
	"lanciarazzi_pesante": {
		...
		"price_money": 30720, "price_material": "metallo", "price_amount": 160,
	...
	"lanciarazzi_avanzato": {
		...
		"price_money": 49150, "price_material": "metallo", "price_amount": 200,
	...
	"balestra_potenziata": {
		...
		"price_money": 6500, "price_material": "metallo", "price_amount": 60,
	...
	"lanciagranate_puzzolente": {
		...
		"price_money": 10400, "price_material": "metallo", "price_amount": 95,
	...
	"lanciarazzi_incendiario": {
		...
		"price_money": 16640, "price_material": "metallo", "price_amount": 125,
	...
	"lanciagranate_a_grappolo_speciale": {
		...
		"price_money": 26625, "price_material": "metallo", "price_amount": 165,
	...
	"lanciarazzi_tossico": {
		...
		"price_money": 42600, "price_material": "metallo", "price_amount": 195,
