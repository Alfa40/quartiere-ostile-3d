...
const CATEGORIES := {
	...
	"mitra": {"label": "Mitra", "unlocked": true},
...
const CATEGORY_WEAPONS := {
	...
	"mitra": ["mitra_artigianale", "mitra_pattuglia", "mitra_pesante", "mitra_assalto", "mitra_guerra"],
...
const WEAPONS := {
	...
	"mitraglietta_aria_compressa": {
		"label": "Mitraglietta ad aria compressa", "category": "mitragliette", "tier": 1, "fire_mode": "auto",
	...
	"mitraglietta_compatta": {
		"label": "Mitraglietta compatta", "category": "mitragliette", "tier": 2, "fire_mode": "auto",
	...
	"mitraglietta_tattica": {
		"label": "Mitraglietta tattica", "category": "mitragliette", "tier": 3, "fire_mode": "auto",
	...
	"mitraglietta_militare": {
		"label": "Mitraglietta militare", "category": "mitragliette", "tier": 4, "fire_mode": "auto",
	...
	"mitraglietta_incursione": {
		"label": "Mitraglietta da incursione", "category": "mitragliette", "tier": 5, "fire_mode": "auto",
	...
	"mitra_artigianale": {
		"label": "Mitra artigianale", "category": "mitra", "tier": 1, "fire_mode": "auto",
	...
	"mitra_pattuglia": {
		"label": "Mitra da pattuglia", "category": "mitra", "tier": 2, "fire_mode": "auto",
	...
	"mitra_pesante": {
		"label": "Mitra pesante", "category": "mitra", "tier": 3, "fire_mode": "auto",
	...
	"mitra_assalto": {
		"label": "Mitra da assalto", "category": "mitra", "tier": 4, "fire_mode": "auto",
	...
	"mitra_guerra": {
		"label": "Mitra da guerra", "category": "mitra", "tier": 5, "fire_mode": "auto",
	...
	"pompa_arrugginito": {
		"label": "Fucile a pompa arrugginito", "category": "fucile_a_pompa", "tier": 1, "fire_mode": "single",
	...
	"pompa_corto": {
		"label": "Fucile a pompa corto", "category": "fucile_a_pompa", "tier": 2, "fire_mode": "single",
	...
	"pompa_tattico": {
		"label": "Fucile a pompa tattico", "category": "fucile_a_pompa", "tier": 3, "fire_mode": "single",
	...
	"pompa_militare": {
		"label": "Fucile a pompa militare", "category": "fucile_a_pompa", "tier": 4, "fire_mode": "single",
	...
	"pompa_demolizione": {
		"label": "Fucile a pompa da demolizione", "category": "fucile_a_pompa", "tier": 5, "fire_mode": "single",
	...
	"fucile_caccia": {
		"label": "Fucile da caccia modificato", "category": "cecchino", "tier": 1, "fire_mode": "single",
	...
	"carabina_precisione": {
		"label": "Carabina di precisione", "category": "cecchino", "tier": 2, "fire_mode": "single",
		"price_money": 1700, "price_material": "metallo", "price_amount": 65,
	...
	"tiratore_scelto": {
		"label": "Fucile da tiratore scelto", "category": "cecchino", "tier": 3, "fire_mode": "single",
	...
	"anti_materiale": {
		"label": "Fucile anti-materiale", "category": "cecchino", "tier": 4, "fire_mode": "single",
	...
	"cecchino_leggendario": {
		"label": "Fucile da cecchino leggendario", "category": "cecchino", "tier": 5, "fire_mode": "single",
