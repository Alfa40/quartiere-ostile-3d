...
const WEAPONS := {
	...
	"mazza_baseball": {
		...
		"damage": 41.0, "cooldown": 0.55, "reach_mult": 1.00, "draw_time": 0.20, "knockback": 2.0,
	},
	"spranga_ferro": {
		"label": "Spranga di ferro", "category": "mazze", "tier": 2,
		"price_money": 210, "price_material": "metallo", "price_amount": 8,
		"damage": 53.0, "cooldown": 0.52, "reach_mult": 1.00, "draw_time": 0.18, "knockback": 2.3,
	},
	"mazza_chiodata": {
		"label": "Mazza chiodata", "category": "mazze", "tier": 3,
		"price_money": 380, "price_material": "metallo", "price_amount": 12,
		"damage": 71.0, "cooldown": 0.50, "reach_mult": 1.05, "draw_time": 0.16, "knockback": 2.6,
	},
	"mazza_da_golf_rinforzata": {
		...
		"damage": 92.0, "cooldown": 0.47, "reach_mult": 1.05, "draw_time": 0.14, "knockback": 2.9,
	},
	"mazza_da_guerra": {
		"label": "Mazza da guerra", "category": "mazze", "tier": 5,
		"price_money": 1000, "price_material": "metallo", "price_amount": 30,
		"damage": 127.0, "cooldown": 0.45, "reach_mult": 1.10, "draw_time": 0.10, "knockback": 3.2,
	},
	...
	"martello_carpentiere": {
		...
		"damage": 58.0, "cooldown": 0.65, "reach_mult": 0.95, "draw_time": 0.25, "knockback": 1.8,
	},
	"martello_fabbro": {
		"label": "Martello da fabbro", "category": "martelli", "tier": 2,
		"price_money": 230, "price_material": "metallo", "price_amount": 9,
		"damage": 76.0, "cooldown": 0.62, "reach_mult": 0.95, "draw_time": 0.22, "knockback": 2.2,
	},
	"mazzuolo_pesante": {
		"label": "Mazzuolo pesante", "category": "martelli", "tier": 3,
		"price_money": 420, "price_material": "metallo", "price_amount": 14,
		"damage": 101.0, "cooldown": 0.60, "reach_mult": 1.00, "draw_time": 0.20, "knockback": 2.7,
	},
	"martello_demolizione": {
		...
		"damage": 133.0, "cooldown": 0.57, "reach_mult": 1.00, "draw_time": 0.18, "knockback": 3.3,
	},
	"martello_da_guerra": {
		"label": "Martello da guerra", "category": "martelli", "tier": 5,
		"price_money": 1100, "price_material": "metallo", "price_amount": 34,
		"damage": 185.0, "cooldown": 0.55, "reach_mult": 1.05, "draw_time": 0.14, "knockback": 4.5,
	},
